                                      ...
                                      if (licData.finished && licData.winnerId) {
                                        ...
                                        db.query(
                                          ...
                                          (errWon, wonRows) => {
                                            ...
                                            const totalWon =
                                              (wonRows && wonRows[0] && wonRows[0].totalWon) || 0;
                                            console.log(
                                              ...
                                              if (totalWon === 10) {
                                                ...
                                                db.query(
                                                  ...
                                                  (updateErr) => {
                                                    if (updateErr) {
                                                      console.error(
                                                        "Error adding 100 points for Mexico:",
                                                        updateErr
                                                      );
                                                      if (!res.headersSent) {
                                                        return res
                                                    ...
                                                    db.query(
                                                      ...
                                                      (scoreErr, scoreResults) => {
                                                        if (scoreErr) {
                                                          console.error(
                                                            "Error fetching updated scores after Mexico win:",
                                                            scoreErr
                                                          );
                                                          if (!res.headersSent) {
                                                            return res
                                                        ...
                                                        if (topPlayers.length === 1) {
                                                          ...
                                                          db.query(
                                                            ...
                                                            (updateErr2) => {
                                                              ...
                                                              console.log(
                                                                "Tie detected among players, starting tie-break round."
                                                              );
                                                              createNewRoundServerSide(
                                                                gameId,
                                                                io,
                                                                ...
                                                                .then(() => {
                                                                  if (!res.headersSent) {
                                                                    return res
                                                                      ...
                                                                      .json({
                                                                        message:
                                                                          "Tie detected, nova runda je startovana.",
                                                                      });
                                                                  }
                                                                })
                                                                .catch((errCreate) => {
                                                ...
                                                return; // Prekid daljeg toka nakon Meksiko pobede
                                              } else {
                                                    ...
                                                    if (totalWon > 0) {
                                                      db.query(
                                                        ...
                                                        (updErr2) => {
                                                          if (updErr2)
                                                            console.error(
                                                              "Greška pri oduzimanju osvojenih bodova:",
                                                              updErr2
                                                            );
                                                        }
                                                      );
                                            ...
                                            db.query(
                                              ...
                                              (scoreErr, scoreResults) => {
                                                ...
                                                const topPlayers = scores.filter(
                                                  (s) => s.score === maxScore
                                                );
                                                    ...
                                                    .then(() => {
                                                      if (!res.headersSent) {
                                                        return res.status(200).json({
                                                          message: "Nova runda je startovana.",
                                                        });
                                                      }
                                                    })
                                                    .catch((errCreate) => {
                                                      ...
                                                      if (!res.headersSent) {
                                                        return res
                                                          .status(500)
                                                          .json({ error: "Greška u kreiranju runde." });
                                                      }
                                                    });
                                                  return;
                                                }
                                                        ...
                                                        .catch((errCreate) => {
                                                          ...
                                                          if (!res.headersSent) {
                                                            return res.status(500).json({
                                                              error: "Greška u kreiranju runde.",
                                                            });
                                                          }
                                                        });
                                                    }
                                        ...
                                        // Ako licitacija nije završena, starta se nova runda
                                        createNewRoundServerSide(gameId, io, db)
                                          .then(() => {
                                            if (!res.headersSent) {
                                              return res
                                                .status(200)
                                                .json({ message: "Nova runda je startovana." });
                                            }
                                          })
                                          .catch((errCreate) => {
                                            console.error(
